...
Item {
    ...
    property var menuData: [
        {
            title: "基准标定",
            iconName: "icon_check_circle",
            iconText: "🎯",
            pageSource: "CalibrationPage.qml",
            enabled: true
        },
        {
            title: "系统配置",
            ...
            iconText: "⚙",
            pageSource: "SystemConfigPage.qml",
            enabled: true
        }
    ]
    ...
    RowLayout {
        ...
        Rectangle {
            ...
            Loader {
                id: contentLoader
                anchors.fill: parent
                source: (root.menuData && root.menuData.length > 0) ? root.menuData[0].pageSource : "CalibrationPage.qml"
            }
        }
    }
}
