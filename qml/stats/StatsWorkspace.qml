...
Item {
    ...
    // ========== 统计分析二级导航（精简为 3 个清晰的核心分析板块） ==========
    property var menuData: [
        {
            title: "轮位质量",
            iconName: "icon_chart_bar",
            iconText: "📊",
            pageSource: "WheelStatsPage.qml",
            enabled: true
        },
        {
            title: "架损分布",
            iconName: "icon_chart_line",
            iconText: "📈",
            pageSource: "RackStatsPage.qml",
            enabled: true
        },
        {
            title: "周报统计",
